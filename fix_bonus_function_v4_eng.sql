-- Виправлення функцій з англійськими описами (щоб уникнути проблем з кодуванням)
...
BEGIN
    ...
    IF spent_bonus > 0 THEN
        INSERT INTO transaction_bonus (
            ...
            'Bonus payment for transaction #' || p_transaction_id,  -- Англійський опис
    ...
    IF earned_bonus > 0 THEN
        INSERT INTO transaction_bonus (
            ...
            'Earned ' || p_bonus || '% bonus for transaction #' || p_transaction_id,  -- Англійський опис
        ...
        IF TG_OP = 'INSERT' THEN
            ...
            IF spent_bonus > 0 THEN
                INSERT INTO transaction_bonus (
                    ...
                    client_current_bonus_kopecks, client_current_bonus_kopecks - spent_bonus_kopecks,
                    'Bonus payment for transaction #' || NEW.transaction_id,  -- Англійський опис
            ...
            IF earned_bonus > 0 THEN
                INSERT INTO transaction_bonus (
                    ...
                    client_current_bonus_kopecks, client_current_bonus_kopecks + earned_bonus_kopecks,
                    'Earned ' || NEW.bonus || '% bonus for transaction #' || NEW.transaction_id,  -- Англійський опис
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        RAISE NOTICE 'Error in trigger process_bonus_operations for transaction %: %',
